...
const HomePage = () => {
  ...
  const [status, setStatus] = react.useState("[0, 1, 2, 3, 4, 5]");
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(
            designSystem.Field.Root,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsxs(designSystem.SingleSelect, { withTags: true, value: status, children: [
                  /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "[0, 1, 2, 3, 4, 5]", children: "All Status" }),
...
exports.App = App;
//# sourceMappingURL=App-B4RObpV7.js.map
