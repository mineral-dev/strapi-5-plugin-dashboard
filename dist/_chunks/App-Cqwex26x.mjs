...
const HomePage = () => {
  ...
  const [status, setStatus] = useState("[0, 1, 2, 3, 4, 5]");
          ...
          /* @__PURE__ */ jsxs(
            Field.Root,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs(SingleSelect, { withTags: true, value: status, children: [
                  /* @__PURE__ */ jsx(SingleSelectOption, { value: "[0, 1, 2, 3, 4, 5]", children: "All Status" }),
...
//# sourceMappingURL=App-Cqwex26x.mjs.map
