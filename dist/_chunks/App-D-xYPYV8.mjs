...
import { Flex, Card, CardBody, CardContent, Typography, Button, Main, Box, Grid, CardHeader, CardTitle, Field, DatePicker, MultiSelect, MultiSelectOption } from "@strapi/design-system";
  ...
  return /* @__PURE__ */ jsx(Main, { children: /* @__PURE__ */ jsxs(Box, { direction: "column", marginTop: 7, marginLeft: 5, marginRight: 5, marginBottom: 7, children: [
    ...
    /* @__PURE__ */ jsxs(Grid.Root, { marginTop: 3, marginBottom: true, gap: 3, children: [
      ...
      /* @__PURE__ */ jsx(Grid.Item, { col: 3, children: /* @__PURE__ */ jsxs(Box, { children: [
        ...
        /* @__PURE__ */ jsx(Flex, { gap: 3, marginTop: 2, children: /* @__PURE__ */ jsxs(
          Field.Root,
          {
            id: "filter",
            children: [
              /* @__PURE__ */ jsx(Field.Label, { children: "Status" }),
              /* @__PURE__ */ jsxs(MultiSelect, { withTags: true, value: ["apple", "avocado"], children: [
                /* @__PURE__ */ jsx(MultiSelectOption, { value: "apple", children: "Apple" }),
                /* @__PURE__ */ jsx(MultiSelectOption, { value: "avocado", children: "Avocado" })
              ] }),
              /* @__PURE__ */ jsx(Field.Error, {}),
              /* @__PURE__ */ jsx(Field.Hint, {})
            ]
...
//# sourceMappingURL=App-D-xYPYV8.mjs.map
