...
const HomePage = () => {
  ...
  const handleStart = (value) => {
    ...
    setStartDate(dayjs__default.default(value).format("YYYY-MM-DD"));
  };
  const handleEnd = (value) => {
    console.log("value end", value);
    setEndDate(dayjs__default.default(value).format("YYYY-MM-DD"));
  };
...
exports.App = App;
//# sourceMappingURL=App-B7xGfN5R.js.map
